...
-- implementing credit card number validation using Mod 10 algorithm
...
-- 2: Add the 2 digits of any double digit number i.e. substract 9 to results higher than 9
